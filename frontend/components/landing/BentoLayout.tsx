    ...
    <section className="py-24 px-6 bg-background">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 md:grid-rows-2 gap-6 min-h-150">
          <div className="md:col-span-2 md:row-span-2 bg-card/40 border border-border p-10 rounded-[2rem] flex flex-col justify-between relative overflow-hidden group">
            ...
            <div className="mt-12 h-64 border-2 border-dashed border-border rounded-2xl flex items-center justify-center bg-card group-hover:bg-card/80 transition-all cursor-pointer">
          ...
          <div className="md:col-span-2 bg-card/40 border border-border p-8 rounded-[2rem] flex items-center justify-between group hover:bg-card/60 transition-colors">
            <div>
